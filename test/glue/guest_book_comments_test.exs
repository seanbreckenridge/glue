defmodule Glue.GuestBookCommentsTest do
  ...
  describe "gb_comment" do
    ...
    test "get_guest_book_comment!/1 returns the guest_book_comment with given id" do
      guest_book_comment = guest_book_comment_fixture()
      assert GuestBookComments.get_guest_book_comment!(guest_book_comment.id) == guest_book_comment
    end

    test "create_guest_book_comment/1 with valid data creates a guest_book_comment" do
      assert {:ok, %GuestBookComment{} = guest_book_comment} = GuestBookComments.create_guest_book_comment(@valid_attrs)
    ...
    test "create_guest_book_comment/1 with invalid data returns error changeset" do
      assert {:error, %Ecto.Changeset{}} = GuestBookComments.create_guest_book_comment(@invalid_attrs)
    end

    test "update_guest_book_comment/2 with valid data updates the guest_book_comment" do
      guest_book_comment = guest_book_comment_fixture()
      assert {:ok, %GuestBookComment{} = guest_book_comment} = GuestBookComments.update_guest_book_comment(guest_book_comment, @update_attrs)
    ...
    test "update_guest_book_comment/2 with invalid data returns error changeset" do
      guest_book_comment = guest_book_comment_fixture()
      assert {:error, %Ecto.Changeset{}} = GuestBookComments.update_guest_book_comment(guest_book_comment, @invalid_attrs)
      assert guest_book_comment == GuestBookComments.get_guest_book_comment!(guest_book_comment.id)
    end

    test "delete_guest_book_comment/1 deletes the guest_book_comment" do
      guest_book_comment = guest_book_comment_fixture()
      assert {:ok, %GuestBookComment{}} = GuestBookComments.delete_guest_book_comment(guest_book_comment)
      assert_raise Ecto.NoResultsError, fn -> GuestBookComments.get_guest_book_comment!(guest_book_comment.id) end
    end
