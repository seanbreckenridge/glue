defmodule Glue.Feed.ImageCache.Server do
  @moduledoc """
  Caches Images for Trakt and MAL
  Requests are received from the Feed.Server whenever feeds are updated
  and are requested from GlueWeb API Endpoint for the Feed.
  """
  ...
  # receives messages to cache images from Feed.Server
