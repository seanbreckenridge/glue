defmodule GlueWeb.GuestBookCommentController do
  ...
  def create(conn, %{"guest_book_comment" => guest_book_comment_params}) do
    with {:ok, %GuestBookComment{} = guest_book_comment} <- GuestBookComments.create_guest_book_comment(guest_book_comment_params) do
      conn
      |> put_status(:created)
  ...
  def update(conn, %{"id" => id, "guest_book_comment" => guest_book_comment_params}) do
    ...
    with {:ok, %GuestBookComment{} = guest_book_comment} <- GuestBookComments.update_guest_book_comment(guest_book_comment, guest_book_comment_params) do
      render(conn, "show.json", guest_book_comment: guest_book_comment)
    end
  end
  ...
  def delete(conn, %{"id" => id}) do
    ...
    with {:ok, %GuestBookComment{}} <- GuestBookComments.delete_guest_book_comment(guest_book_comment) do
